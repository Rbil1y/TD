...
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/Rbil1y)
...
<body>
  <div class="card">
    <img src="https://i.postimg.cc/FdKW37fL/image.jpg" alt="Billy Rolph Exumé" />
...
```mermaid
graph TD
    A[🖥️ Utilisateur] --> B[Interface Web - React]
    B --> C[API REST]
    C --> D[Base de données - Supabase]
    C --> E[Authentification - Firebase]
    C --> F[Stockage - Google Cloud]
    B --> G[📱 App Mobile - React Native]
    G --> C
```
